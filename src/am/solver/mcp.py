...
def register_solver(app: FastMCP):
    ...
    def solver_measure_melt_pool_dimensions(
        ...
        try:
            ...
            out_path = solver.measure_melt_pool_dimensions(build_parameters, material_config, workspace_path, run_name)
    ...
    def solver_run_layer(
        ...
        try:
            ...
            run_out_path = solver.run_layer(segments, build_parameters, material_config, mesh_config, workspace_path, model_name, run_name)
